...
jQuery(function($){
$('#form_usuario').mask("000.000.000-00",{placeholder:" "});
});
	...
	<body>
		...
		<p>Para editar, apenas digite o nome de usuário que deseja editar.</p>
                <p><a href="../../VIEW/login_candidato.php">Clique aqui</a> para efetuar o login.</p>
		<form action="" method="post">
			<table>
				...
				<tr>
					<td><input type="text" id="form_usuario"  name="form_usuario" required></td>
				</tr>
				<tr>
					<td>Senha</td>
				</tr>
